...
Итог:
![db.png](https://github.com/mikhail-med/ds_internship/blob/main/db-pngs/db.png "db.png")
...
![db.png](https://github.com/mikhail-med/ds_internship/blob/main/db-pngs/db2.png "db.png")
...
### БД
![db3.png](https://github.com/mikhail-med/ds_internship/blob/main/db-pngs/db3.png "db3.png")

# Промежуточный результат №5
- fix шифрования пароля пользователя при обновлении
- добавлено исключение если пользователь не является участником на стажировку, но происходит попытка получить статистику по нему
- добавлена проверка при попытке обновить/удалить сущность с несуществующим id
- gitlab client вместо возврата false или null выбрасывает checked исключение
- методы получения ведомости и успеваемости перенесены в отдельный сервис
